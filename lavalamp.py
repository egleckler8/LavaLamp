...
class LampGen():
    ...
    def createSample(self, p):
        ...
        z = p[
            4]  # we use a 2D "slice" of a 3d noise field at a random z-coordinate so each field isn't the same each time--the noise module is determinate
    ...
    def createSwirl(self, amplitude=1.0):
        ...
        for x in range(self.total_frames):
            noise_value = noise.pnoise1(x - 0.888,
                                        octaves=6)  # this 0.888 is SUPER IMPORTANT because perlin noise always is 0 at int values!!
    ...
    def randSeed(self):
        ...
        # created uniquely, even in quick sucession...
    ...
    def generateParams(self, seed):
        ...
        # uses the fourth digit as an int, so the range of octaves is 3-12. Keeping octaes
    ...
    def createGIF(self, s=None, filepath=""):
